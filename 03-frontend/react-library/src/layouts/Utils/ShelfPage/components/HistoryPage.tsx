...
export const HistoryPage = () => {
  ...
  useEffect(() => {
    const fetchUserHistory = async () => {
      if (isAuthenticated) {
        ...
        const url = `http://localhost:8080/api/histories/search/findBooksByUserEmail?userEmail=${userEmail}&page=${
          currentPage - 1
        }&size=5`;
  ...
  }, [isAuthenticated,user?.email, getAccessTokenSilently, getIdTokenClaims, currentPage]);
                  ...
                  <div className="col-md-2">
                    <div className="d-none d-lg-block">
                      {history.img ? (
                        ...
                        // update bath to Images/BooksImages/book-luv2code-1000.png
                        <img
